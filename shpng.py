...
while(z!=0):     
	...
	if(user=="4"):   #books
		...
		grocery=[" "," Karachi Biscuits"," Dark Fantasy "," Lays"," Kurkure "," Salt","Olive oil"," Honey"," ThumpsUp"," Red Label Tea"," Maaza"," Brizzer"," Horlicks"," Surf Excel"," Maggi"]
		grocery_cost=[0,250,40,20,10,20,500,100,60,55,60,180,90,20]
...
if(t!=0):
	...
	if(user=="ENS"):
		...
		print("1 Net banking")
		print("2 Credit card")                                    #    need to edit    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
